						...
						<div class="col_one_third">
							...
							<div class="widget widget_links clearfix">
								...
								<ul>
									...
									<li><a href="{{ url('/postlistsmyanmar', $category->id) }}">{{ $category->mname }}</a></li>
			...
			<div id="copyrights">
				...
				<div class="container clearfix">
					...
					<div class="col_half">
						...
						<div class="copyright-links"><a href="termscondationmyanmar">Terms of Use</a> / <a href="privacypolicymyanmar">Privacy Policy</a></div>
					</div>
