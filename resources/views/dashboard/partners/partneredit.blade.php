...
<div id="content">
	<div id="content-header">
		<div id="breadcrumb"> <a href="{{ url('/dashboard') }}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">edit partner</a> </div>
					...
					<form action="{{ route("partners.update", $partner->id) }}" method="POST" enctype="multipart/form-data">
							...
							<input type="hidden" name="_token" value="{{ csrf_token() }}">
								...
								<ul class="thumbnails">
									<li class="span3"> <a> 
										...
										<label for="file-input1">
											<i class="icon-camera"></i>.Main 125 X 33<br>
											@if($partner->photourl1!="")
											<img id="blah" src= "{{ $partner->photourl1 }}" width="100" height="100">
											@else
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" class="span11" id="" name="name" placeholder="Enter Name" value="{{ $partner->name }}" required>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" class="span11" id="" name="urllink" placeholder="Enter url link" value="{{ $partner->urllink }}">
									</div>
								</div> 
								<div class="control-group">
									<label class="control-label">Description:</label>
									<div class="controls">
										<textarea class="textarea_editor span12" name="description" placeholder="Enter your description" class="span11" rows="4">{{ $partner->description }}</textarea>
