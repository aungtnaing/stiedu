...
<div id="content">
	<div id="content-header">
		<div id="breadcrumb"> <a href="{{ url('/dashboard') }}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">new partner</a> </div>
		<!-- <h1>USER LISTS</h1> -->
	</div>
					...
					<div class="widget-content nopadding">
						<form action="{{ route("partners.store") }}" method="POST" enctype="multipart/form-data">
							...
							<ul class="thumbnails">
								<li class="span3"> <a> 
									...
									<label for="file-input1">
										<i class="icon-camera"></i>.Logo 125x33<br>
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span11" id="" name="urllink" placeholder="Enter url link" value="{{ old('urllink') }}" required>
								</div>
							</div> 
							<div class="control-group">
