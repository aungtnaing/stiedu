...
<div id="content">
	<div id="content-header">
		<div id="breadcrumb"> <a href="{{ url('/dashboard') }}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">new blog</a> </div>
		<!-- <h1>USER LISTS</h1> -->
	</div>
					...
					<div class="widget-content nopadding">
						<form action="{{ route("blogs.store") }}" method="POST" enctype="multipart/form-data">
							...
							<ul class="thumbnails">
								<li class="span3"> <a> 
									...
									<label for="file-input1">
										<i class="icon-camera"></i>.Main 560x390<br>
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span11" id="" name="bloger" placeholder="Enter bloger" value="{{ old('bloger') }}" required>
								</div>
							</div> 
							<div class="control-group">
								<label class="control-label">Content:</label>
								<div class="controls">
									<textarea class="textarea_editor span12" name="content" placeholder="Enter your content" class="span11" rows="4"></textarea>
