        ...
        <div class="widget-box">
          ...
          <input type="hidden" name="_token" value="{{ csrf_token() }}">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input name="name" class="span11" value="{{ $post->mname }}" placeholder="Enter Your Post Name(ျမန္မာ)" type="text" required>
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input name="subtitle" class="span11" value="{{ $post->msubtitle }}" placeholder="Enter Your Sub Title(ျမန္မာ)" type="text">
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
              <textarea class="textarea_editor span12" name="description" placeholder="Enter your post content(ျမန္မာ)" class="span11" rows="7">{{ $post->mdescription }}</textarea>
