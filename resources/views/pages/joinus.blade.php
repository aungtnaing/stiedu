					...
					<div class="col_two_fifth nobottommargin col_last">
						...
						<!-- <div class="contact-widget"> -->
								...
								<div class="col_half">
									...
									<input type="text" name="age" size="22" tabindex="4" class="sm-form-control" required/>
								</div>

								<div class="col_half col_last">
									<label for="template-jobform-city">City <small>*</small></label>
									<input type="text" name="city" id="template-jobform-city" value="" size="22" tabindex="5" class="sm-form-control" required/>
								</div>
								...
								<div class="col_full">
									...
									<select name="position" id="template-jobform-position"  tabindex="9" class="sm-form-control">
								...
								<div class="col_half">
									...
									<input type="text" name="salary" id="template-jobform-salary" value="" size="22" tabindex="6" class="sm-form-control" />
								</div>

								<div class="col_half col_last">
									<label for="template-jobform-time">Start Date</label>
									<input type="text" name="startdate" id="template-jobform-start" value="" size="22" tabindex="7" class="sm-form-control" />
								</div>
								...
								<input id="input-5" name="cv[]" type="file" multiple class="file-loading">
							</div>
							</div>
