		...
		<div class="container">
			...
			<div class="row">
				<section id="main" class="col-md-8">
					...
					<h2 class="entry-title" style="color:#050930;">Get Application Form(enroll)</h2>
						<p>Plese fill your's information for get applicaion form.</p>
					...
					<form action="{{ route("visitors.store") }}" method="POST" enctype="multiGet Brochurespart/form-data">
							...
							<div class="col-md-9 personal-info">
								...
								<input type="text" name="type" value="enroll ({{ $coursedetail->name }})" style="display:none">
								<input type="text" name="courseid" value="{{ $coursedetail->id }}" style="display:none">
								...
								<div class="control-group">
									...
									<div class="col-md-8">
										...
										<input class="btn btn-primary" name="submittype" type="submit" value="Get Application Form"> 
