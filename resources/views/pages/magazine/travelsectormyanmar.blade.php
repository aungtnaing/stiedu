<div class="col_full bottommargin-lg clearfix">
	...
	<div class="ipost clearfix">
		...
		<div class="col_half bottommargin-sm col_last">
			<div class="entry-title">
				<h3><a href="{{ url('/postdetailsmyanmar', $travelsectorposts[0]->id) }}">{{ $travelsectorposts[0]->mname }}</a></h3>
			</div>
			<ul class="entry-meta clearfix">
				<li><i class="icon-calendar3"></i>{{ $travelsectorposts[0]->created_at }}</li>
				<li><a href="{{ url('/postdetailsmyanmar', $travelsectorposts[0]->id) }}"><i class="icon-comments"></i>{{ $tcmt }}</a></li>
	...
	<div class="col_half nobottommargin">
		...
		<div class="spost clearfix">
			...
			<div class="entry-c">
				<div class="entry-title">
					<h4><a href="{{ url('/postdetailsmyanmar', $travelsectorposts[1]->id) }}">{{ $travelsectorposts[1]->mname }}</a></h4>
				</div>
				<ul class="entry-meta">
					<li><i class="icon-calendar3"></i>{{ $travelsectorposts[1]->created_at }}</li>
					<li><a href="{{ url('/postdetailsmyanmar', $travelsectorposts[1]->id) }}"><i class="icon-comments"></i> {{ $tcmt }}</a></li>
				</ul>
			</div>
		</div>
		...
		<div class="spost clearfix">
			...
			<div class="entry-c">
				<div class="entry-title">
					<h4><a href="{{ url('/postdetailsmyanmar', $travelsectorposts[2]->id) }}">{{ $travelsectorposts[2]->mname }}</a></h4>
				</div>
				<ul class="entry-meta">
					<li><i class="icon-calendar3"></i>{{ $travelsectorposts[2]->created_at }}</li>
					<li><a href="{{ url('/postdetailsmyanmar', $travelsectorposts[2]->id) }}"><i class="icon-comments"></i> {{ $tcmt }}</a></li>
				</ul>
			</div>
		</div>
	...
	<div class="col_half nobottommargin col_last">
		...
		<div class="spost clearfix">
			...
			<div class="entry-c">
				<div class="entry-title">
					<h4><a href="{{ url('/postdetailsmyanmar', $travelsectorposts[3]->id) }}">{{ $travelsectorposts[3]->mname }}</a></h4>
				</div>
				<ul class="entry-meta">
					<li><i class="icon-calendar3"></i>{{ $travelsectorposts[3]->created_at }}</li>
					<li><a href="{{ url('/postdetailsmyanmar', $travelsectorposts[3]->id) }}"><i class="icon-comments"></i> {{ $tcmt }}</a></li>
				</ul>
			</div>
		</div>
		...
		<div class="spost clearfix">
			...
			<div class="entry-c">
				<div class="entry-title">
					<h4><a href="{{ url('/postdetailsmyanmar', $travelsectorposts[4]->id) }}">{{ $travelsectorposts[4]->mname }}</a></h4>
				</div>
				<ul class="entry-meta">
					<li><i class="icon-calendar3"></i>{{ $travelsectorposts[4]->created_at }}</li>
					<li><a href="{{ url('/postdetailsmyanmar', $travelsectorposts[4]->id) }}"><i class="icon-comments"></i> {{ $tcmt }}</a></li>
				</ul>
			</div>
		</div>
