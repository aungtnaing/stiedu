<div class="col_full nobottommargin clearfix">
	...
	<div class="col_one_third">
		<div class="ipost clearfix">
			...
			<div class="entry-title">
				<h3><a href="{{ url('/postdetails', $arrival->id) }}">{{ $arrival->name }}</a></h3>
			</div>
			<ul class="entry-meta clearfix">
				<li><i class="icon-calendar3"></i>{{ $arrival->created_at }}</li>
				<li><a href="{{ url('/postdetails', $arrival->id) }}"><i class="icon-comments"></i>{{ $tcmt }}</a></li>
			</ul>
	...
	<div class="col_one_third nobottommargin">
		<div class="ipost clearfix">
			...
			<div class="entry-title">
				<h3><a href="{{ url('/postdetails', $infocu->id) }}">{{ $infocu->name }}</a></h3>
			</div>
			<ul class="entry-meta clearfix">
				<li><i class="icon-calendar3"></i>{{ $infocu->created_at }}</li>
				<li><a href="{{ url('/postdetails', $infocu->id) }}"><i class="icon-comments"></i> {{ $tcmt }}</a></li>
			</ul>
			<div class="entry-content">
