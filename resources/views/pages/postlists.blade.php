...
<section id="page-title">
	...
	<div class="container clearfix">
		...
		<h1>{{ $postlists[0]->category->name }}</h1>
		@else
		<h1>None</h1>
		@endif
							...
							<div class="entry clearfix">
								...
								<div class="entry-c">
									<div class="entry-title">
										<h2><a href="{{ url('/postdetails', $postlist->id) }}">{{ $postlist->name }}</a></h2>
									</div>
									...
									<div class="entry-content">
										...
										<a href="{{ url('/postdetails', $postlist->id) }}" class="btn btn-danger">Read More</a>
									</div>
								</div>
							</div>
							@endforeach
							...
							<div class="widget clearfix">
								...
								@foreach($latestposts as $latestpost)
									<div class="spost clearfix">
										...
										<div class="entry-c">
											<div class="entry-title">
												<h4><a href="{{ url('/postdetails', $latestpost->id) }}">{{ $latestpost->name }}</a></h4>
											</div>
											<ul class="entry-meta">
