...
<head>
  ...
  <meta property="og:description"   content="{{ $blogdetail->content }}" />
  <meta property="og:image"         content="<?php echo url(); ?>{{ $blogdetail->photourl1 }}" />
<meta property="fb:app_id" content="132711514007187" />

  <title>{{ $blogdetail->title }}</title>
  <meta name="description" content="{{ $blogdetail->content }}">
